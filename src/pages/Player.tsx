          ...
          <div className='flex-1'>
            <div className='w-full bg-zinc-950 aspect-video'>
              <ReactPlayer
                ...
                height="100%"
                controls
                url="https://www.youtube.com/watch?v=_PwRek84XrM"
              />
            </div>
          </div>
          <aside className='w-80 absolute top-0 bottom-0 right-0 border-l border-zinc-800 bg-zinc-900 overflow-y-auto scrollbar-thin scrollbar-track-zinc-950 scrollbar-thumb-zinc-900 divide-y-2 divide-zinc-900'>
            <div className=''>
            ...
            <div className=''>
              ...
              <nav className='relative flex flex-col gap-4 p-6'>
                ...
                <button className='flex items-center gap-3 text-sm text-zinc-400'>
                  <Video className='w-4 h-4 terxt-zinc-500' />
